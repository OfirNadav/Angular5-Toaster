...
[#120](https://github.com/Stabzs/angular5-toaster/issues/120).


# 4.0.0 (2017-5-25)
### BREAKING CHANGES
* **angular5-toaster:** Explicit animation configuration is now required for the library.

### FEATURES
* **angular5-toaster:** Animation support has been added.
Closes [#95](https://github.com/Stabzs/angular5-toaster/issues/95).

* **angular5-toaster:** `angular5-toaster` is now compiled with the `strictNullChecks` flag on by
default.
...
[#112](https://github.com/Stabzs/angular5-toaster/issues/112).
...
Closes [#111](https://github.com/Stabzs/angular5-toaster/issues/111)
...
# 3.0.0 (2017-3-30)
### BREAKING CHANGES
* **angular5-toaster:** The library's Angular dependencies have been pinned to a minimum version of 
4.0.0 for common, compiler, and core.

### Features
* **angular5-toaster:** The library has been recompiled against the 4.0.1 version of the Ahead of 
...
Closes [#106](https://github.com/Stabzs/angular5-toaster/issues/106).

### Bug Fixes
* **toaster.css:** Center-positioned postionClasses now properly align in the middle of the page. 
Closes [#104](https://github.com/Stabzs/angular5-toaster/issues/104).


# 2.0.0 (2016-12-21)
### BREAKING CHANGES
* **angular5-toaster:** The library has been converted to a UMD Format to mirror @angular packages 
...
and require updates to your code.
    - You no longer need to (or can) import from `angular5-toaster/angular5-toaster`.  You can now 
    import directly from `angular5-toaster`.
    - There is no longer a `/lib` folder.  The `toaster.css` file has been moved to the root of the 
    package since this is a top-level file, just like `angular5-toaster`.
    - If you still need to deep-link to a specific file rather than consuming it via 
    `angular5-toaster`, the compiled files are now available under `/src` instead of `/lib`.
    - The default module style for the library is now `es2015` instead of `commonjs`.

### Features
* **angular5-toaster:** UMD files are now included under the `/bundles` folder of the package. The 
UMD files expect `@angular/core`, `@angular/common`, and `rxjs` to exist in the global namespaces 
if being consumed.

### Bug Fixes
* **angular5-toaster:** The peerDependency requirement for rxjs has been relaxed to 
`rxjs@^5.0.0-beta.11`.  This allows for flexibility all the way back to `@angular@2.0.0`. 
Closes [#87](https://github.com/Stabzs/angular5-toaster/issues/87).

* **angular5-toaster:** The `angular5-toaster` package entrance was never compiled via Ahead of 
...
`angular5-toaster`. This has been corrected.
...
Addresses [#84](https://github.com/Stabzs/angular5-toaster/issues/84).
...
[#83](https://github.com/Stabzs/angular5-toaster/issues/83).
...
[#71](https://github.com/Stabzs/angular5-toaster/issues/71).
* **angular5-toaster.js:** The library entrance attempts to load `Toast` from `./lib/toast`.  Since 
the `Toast` file is an interface-only file, there is nothing to load.  Closes 
[#70](https://github.com/Stabzs/angular5-toaster/issues/70).
...
[#67](https://github.com/Stabzs/angular5-toaster/issues/67).


# 1.0.0 (2016-09-15)
### Features
* **Angular: Final Version:** The library has been updated to Angular `2.0.0` and the version has 
been bumped to `1.0.0` as a result. Closes [#63](https://github.com/Stabzs/angular5-toaster/issues/63).
...
longer checked into source.  Closes [#60](https://github.com/Stabzs/angular5-toaster/issues/60).

### Bug Fixes
* **package.json:** The main entrance has been updated to `angular5-toaster.js`.  Addresses 
[#60](https://github.com/Stabzs/angular5-toaster/issues/60).
* **toast.component:** The `bodyOutputType` property is public to enable AoT compilation on the 
template. Closes [#62](https://github.com/Stabzs/angular5-toaster/issues/62).
...
[#64](https://github.com/Stabzs/angular5-toaster/issues/64).


# 0.5.2-rc.7 (2016-09-14)
### Features
* **Angular: RC7:** The library has been updated to Angular RC7.
Closes [#59](https://github.com/Stabzs/angular5-toaster/issues/59).
...
[#58](https://github.com/Stabzs/angular5-toaster/pull/58).


# 0.5.1-rc.6 (2016-09-06)
### Bug Fixes
* **toaster.module:** Toaster Module was improperly using `BrowserModule` when it should have been 
importing `CommonModule`.  Closes [#55](https://github.com/Stabzs/angular5-toaster/issues/55).
...
Closes [#52](https://github.com/Stabzs/angular5-toaster/issues/52).
* **Documentation:** Updated to close 
[#51](https://github.com/Stabzs/angular5-toaster/issues/51).
...
[package.json](https://github.com/Stabzs/angular5-toaster/blob/master/package.json).
Closes [#50](https://github.com/Stabzs/angular5-toaster/issues/50).
...
[#46](https://github.com/Stabzs/angular5-toaster/issues/46).
...
* **Angular:** Toaster is now encapsulated in an ngModule **ToastModule** [#47](https://github.com/Stabzs/angular5-toaster/issues/47).
...
[#35](https://github.com/Stabzs/angular5-toaster/issues/35).
...
[8e6404c](https://github.com/Stabzs/angular5-toaster/commit/8e6404cb474fb95b63c446458d681ccce51d89ec).
* **demo.systemjs:** An additional use case for rendering components with actions (buttons) in the 
toast body has been added to address [#27](https://github.com/Stabzs/angular5-toaster/issues/27). 
...
inner html of the new toast instance and addresses [#24](https://github.com/Stabzs/angular5-toaster/issues/24).
...
Closes [#23](https://github.com/Stabzs/angular5-toaster/issues/23).
...
Fixed via [#20](https://github.com/Stabzs/angular5-toaster/issues/20).
...
This is the first release of angular5-toaster against the Angular2 Release Candidate. All Angular 2 
...
Closes [#14](https://github.com/Stabzs/angular5-toaster/issues/14).
