...
[![Build Status](https://travis-ci.org/Stabzs/angular5-toaster.svg?branch=master)](https://travis-ci.org/Stabzs/angular5-toaster)
[![Coverage Status](https://coveralls.io/repos/github/Stabzs/angular5-toaster/badge.svg?branch=master&b=4.0.1)](https://coveralls.io/github/Stabzs/angular5-toaster?branch=master)


Version ^5.0.0 now supports `@angular/animations`, which is a breaking change.  Please read both 
...
```bash
git clone https://github.com/stabzs/angular5-toaster.git
```
...
Update from https://github.com/Stabzs/angular5-toaster.git
